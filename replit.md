...
## App Versioning
- **Current Version (iOS):** 2.1.4 (TikTok Business SDK + App Tracking Transparency + SKAdNetwork for TikTok Ads iOS install/open attribution)
...
- **Android:** Version in `android/app/build.gradle` — `versionName "2.1.4"`, `versionCode 29`.
