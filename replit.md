...
## App Versioning
- **Current Version:** 2.0.6 (In-app review prompt after marking a listing as sold)
...
- **Android:** Version in `android/app/build.gradle` — `versionName "2.0.6"`, `versionCode 20`.
