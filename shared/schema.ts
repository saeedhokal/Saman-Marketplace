...
export const CAR_MODELS: Record<string, string[]> = {
  ...
  "Motorcycles": [
    ...
    "Yamaha YZF-R1", "Yamaha YZF-R6", "Yamaha YZF-R7", "Yamaha MT-10", "Yamaha MT-09", "Yamaha MT-07",
    "Yamaha MT-03", "Yamaha Tenere 700", "Yamaha Tracer 9", "Yamaha XMAX", "Yamaha NMAX", "Yamaha Aerox",
    "Suzuki GSX-R1000", "Suzuki GSX-R750", "Suzuki V-Strom 1050", "Suzuki Hayabusa", "Suzuki Katana",
    "KTM 1290 Super Duke", "KTM 890 Duke", "KTM 390 Duke", "KTM 1290 Super Adventure", "KTM 890 Adventure",
    ...
    "Aprilia RSV4", "Aprilia Tuono", "Aprilia RS 660",
    "MV Agusta F3", "MV Agusta Brutale",
    "Royal Enfield Classic 350", "Royal Enfield Himalayan", "Royal Enfield Interceptor 650", "Royal Enfield Continental GT 650",
    "Husqvarna Svartpilen", "Husqvarna Vitpilen", "Husqvarna Norden 901",
    "Vespa Primavera", "Vespa Sprint", "Vespa GTS",
    "Sharmax RR 250", "Sharmax RR 801 Ultra", "Sharmax RST 150 Ultra", "Sharmax RST 750 Ultra",
    "Sharmax GL 250", "Sharmax GL 991 Ultra", "Sharmax GP 1100 Ultra", "Sharmax Tank 150",
    "Sharmax Power Max 190", "Sharmax Sport 250", "Sharmax Expert Pro 450"
  ],
  "ATV": [
    "Can-Am Outlander", "Can-Am Outlander Max", "Can-Am Outlander 6x6", "Can-Am Renegade",
    "Yamaha Raptor 700R", "Yamaha YFZ450R", "Yamaha Grizzly 700", "Yamaha Kodiak 700", "Yamaha Kodiak 450",
    "Polaris Sportsman 570", "Polaris Sportsman 850", "Polaris Sportsman XP 1000",
    "Polaris Scrambler XP 1000", "Polaris Outlaw 110",
    "Honda TRX520 Foreman", "Honda TRX420 Rancher", "Honda TRX250X",
    "Suzuki KingQuad 750", "Suzuki KingQuad 500", "Suzuki QuadSport Z400",
    "Kawasaki Brute Force 750", "Kawasaki KFX90",
    "Sharmax Cruiser Race 350 GX", "Sharmax Cruiser 300 FJ", "Sharmax Cruiser Race 550 GX",
    "Sharmax Force 650", "Sharmax Force 1100 EFI EPS", "Sharmax Hummer 320 RX LTD",
    "Sharmax Cross 180 RX", "Sharmax Cross 130", "Sharmax Raizer 250 Race Cup"
  ],
  "UTV": [
    "Can-Am Maverick X3", "Can-Am Maverick X3 Max", "Can-Am Maverick R",
    "Can-Am Maverick Sport", "Can-Am Maverick Trail",
    "Can-Am Commander", "Can-Am Commander Max", "Can-Am Defender", "Can-Am Defender Max",
    "Polaris RZR XP 1000", "Polaris RZR Pro XP", "Polaris RZR Pro R", "Polaris RZR Turbo R",
    "Polaris Ranger XP 1000", "Polaris Ranger Crew XP 1000", "Polaris General XP 1000",
    "Yamaha YXZ1000R", "Yamaha Wolverine RMAX", "Yamaha Wolverine X2", "Yamaha Viking",
    "Kawasaki Teryx KRX 1000", "Kawasaki Teryx4", "Kawasaki Mule Pro",
    "Honda Talon 1000R", "Honda Talon 1000X", "Honda Pioneer 1000", "Honda Pioneer 700",
    "Sharmax Jump 1100 RX", "Sharmax Junior 250", "Sharmax Predator 420",
    "Sharmax Race 580", "Sharmax XForce 1100", "Sharmax XForce 1100 Sport X4"
  ],
  "Tesla": [
