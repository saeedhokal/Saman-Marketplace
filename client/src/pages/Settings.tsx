      ...
      <div className="sticky top-0 z-40 bg-background border-b border-border">
        <div className="container mx-auto px-4">
          <div className="relative flex items-center justify-center h-14">
            <button type="button" onClick={() => window.history.length > 1 ? window.history.back() : (window.location.href = "/profile")} className={`absolute ${isRTL ? 'right-0' : 'left-0'} p-2 rounded-lg hover:bg-secondary transition-colors`} data-testid="button-back">
              ...
              <div className={`flex items-center justify-between py-2 ${isRTL ? 'flex-row-reverse' : ''}`}>
                <div className={`flex items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
                  ...
                  <div className={isRTL ? 'text-right' : ''}>
                    ...
                    <p className="text-sm text-muted-foreground" data-testid="text-app-version">2.0.7</p>
                  </div>
                </div>
              </div>
            </div>
