    ...
    <div className="min-h-screen relative -mt-0">
      ...
      <PullToRefresh onRefresh={handleRefresh} className="relative z-10">
        <div className="container mx-auto px-4 pt-2">
          ...
          <div className="mb-6">
            <div className="relative rounded-2xl overflow-hidden" style={{ maskImage: 'linear-gradient(to right, black 0%, black 35%, transparent 85%)', WebkitMaskImage: 'linear-gradient(to right, black 0%, black 35%, transparent 85%)' }}>
              <div className="absolute inset-0 border border-white/20 rounded-2xl" />
              <div className="absolute inset-0" style={{ background: 'linear-gradient(to right, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0.08) 40%, rgba(255,255,255,0.02) 70%, transparent 100%)', backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)', maskImage: 'linear-gradient(to right, black 0%, black 30%, transparent 85%)', WebkitMaskImage: 'linear-gradient(to right, black 0%, black 30%, transparent 85%)' }} />
              <div className="absolute inset-0" style={{ background: 'linear-gradient(to right, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0.03) 40%, transparent 85%)' }} />
              {/* Content */}
