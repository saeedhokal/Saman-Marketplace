...
export const translations = {
  en: {
    ...
    purchaseSubscription: "Buy Credits",
    aboutUs: "About Us",
  ...
  ar: {
    ...
    searchModels: "ابحث عن الموديل...",
    noModelFound: "لم يتم العثور على موديل",
    year: "السنة",
    mileageKm: "المسافة المقطوعة (كم)",
    spec: "المواصفات",
    specPlaceholder: "اختر المواصفات",
    specGCC: "خليجي",
    specUS: "وارد أمريكا",
    specJapan: "وارد اليابان",
    specEurope: "وارد أوروبا",
    specCanada: "وارد كندا",
    specKorea: "وارد كوريا",
    specOther: "أخرى",
    ...
    purchaseSubscription: "شراء رصيد",
    aboutUs: "عن سامان",
